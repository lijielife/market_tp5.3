                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="table-responsive">
                            <form action="/Admin/Capital/add"  enctype="multipart/form-data" method="post">
                                <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr>
                                        <td class="center"><label style="height: 15px;">模拟id</label></td>
                                        <td><input name="uid" type="text" class="col-xs-10 col-sm-3"></td>
                                    </tr>

                                    <!--<tr>
                                        <td class="center"><label style="height: 15px;">内容</label></td>
                                        <td id="ckf" onclick="ckf()">
                                            <textarea placeholder="点击加载编辑器"  id="editor1" name="text"></textarea>
                                        </td>
                                    </tr>
                                    <tr class="center">
                                    ...
                                    <tr>
                                        <td class="center"></td>
                                        <td>
                                            <button style="float:right;margin-right:5%;height: 30px;width: 55px;" class="btn btn-app btn-grey btn-xs radius-4"><i style="font-size:16px;width:35px;text-align: left;padding-left: 5px;margin-top: -5px;" class="icon-save bigger-160">开户</i></button>
                                        </td>
                                    </tr>
                                    </tbody>
