...
<div class="main-content">
    <div class="breadcrumbs" id="breadcrumbs">
        ...
        <div class="nav-search" id="nav-search"  style="top: 3px;">
            <a href="<?php echo U('Allowip/addshow');?>"><button class="btn btn-sm btn-primary no-border">新增操作IP</button></a>
    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <form action="/Admin/Allowip/alldel"  enctype="multipart/form-data" method="post">
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="table-responsive">
                            <table  id="sample-table-2" class="table table-striped table-bordered table-hover">
                                ...
                                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td><a href="<?php echo U('Allowip/edit',array('id'=>$vo['id']));?>"><?php echo ($vo["ip"]); ?></a></td>
                                    <td>
                                        <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                            &nbsp;
                                            <a title="编辑" class="green" href="<?php echo U('Allowip/edit',array('id'=>$vo['id']));?>">
                                                <i class="icon-pencil bigger-130"></i>
                                            </a>
                                            <a id="id-btn-dialog20"  title="删除" class="red" href="<?php echo U('Allowip/del',array('id'=>$vo['id']));?>" onclick="return confirm('是否确认删除？');">
