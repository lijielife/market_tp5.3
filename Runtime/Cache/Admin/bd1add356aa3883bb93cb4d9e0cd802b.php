...
<div class="main-content">
    <div class="breadcrumbs" id="breadcrumbs">
        ...
        <div class="nav-search" id="nav-search"  style="top: 3px;">
            <a href="<?php echo U('Capital/addshow');?>"><button class="btn btn-sm btn-primary no-border">开户</button></a>
    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <form action="/Admin/Capital/alldel"  enctype="multipart/form-data" method="post">
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="table-responsive">
                            <table  id="sample-table-2" class="table table-striped table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <!--<th>用户名</th>-->
                                    <th style="width: 150px;">初始资产</th>
                                    <th style="width: 150px;">总资产</th>
                                    <th style="width: 150px;" class="hidden-480">总盈亏</th>
                                    <th style="width: 150px;">可用保证金</th>
                                    <th style="width: 150px;">占用保证金</th>
                                    <th style="width: 150px;">冻结保证金</th>
                                    <th style="width: 150px;"><i class="icon-time bigger-110 hidden-480"></i>最后加金时间</th>
                                ...
                                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <!--<td><a href="<?php echo U('Capital/edit',array('id'=>$vo['uid']));?>"><?php echo ($vo["username"]); ?></a></td>-->
                                    <td><?php echo ($vo["initial_capital"]); ?></td>
                                    <td><?php echo ($vo["total_capital"]); ?></td>
                                    <td><?php echo ($vo["total_profit_loss"]); ?></td>
                                    <td><?php echo ($vo["usable_margin"]); ?></td>
                                    <td><?php echo ($vo["uccupy_margin"]); ?></td>
                                    <td><?php echo ($vo["freeze_margin"]); ?></td>
                                    <td class="hidden-480"><?php echo (date("Y-m-d H:i:s",$vo["time"])); ?></td>
                                    <td>
                                        <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                            &nbsp;
                                            <a title="编辑" class="green" href="<?php echo U('Capital/edit',array('id'=>$vo['uid']));?>">
                                                <i class="icon-pencil bigger-130"></i>
                                            </a>
                                            <a id="id-btn-dialog20"  title="删除" class="red" href="<?php echo U('Capital/del',array('id'=>$vo['uid']));?>" onclick="return confirm('是否确认删除？');">
