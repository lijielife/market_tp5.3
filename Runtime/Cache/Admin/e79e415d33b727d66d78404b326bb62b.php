...
<div class="main-content">
    <div class="breadcrumbs" id="breadcrumbs">
        ...
        <div class="nav-search" id="nav-search" style="top: 3px;">
            <a href="<?php echo U('Capital/index');?>"><button class="btn btn-sm btn-primary no-border">返回列表</button></a>
        </div><!-- #nav-search -->
    </div>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="table-responsive">
                            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><table id="sample-table-2" class="table table-striped table-bordered table-hover">
                                    <thead>
                                    <tr>
                                    ...
                                    <tbody style="font-family:'Microsoft YaHei';">
                                            ...
                                            <tr>
                                                <td class="center"><label style="height: 15px;">用户名</label></td>
                                                <td><label><?php echo ($vo["username"]); ?></label></td>
                                            </tr>
                                            <tr>
                                                <td class="center"><label style="height: 15px;">初始资金</label></td>
                                                <td><label><?php echo ($vo["initial_capital"]); ?></label></td>
                                            </tr>
                                            <tr>
                                                <td class="center"><label style="height: 15px;">总资产</label></td>
                                                <td><label><?php echo ($vo["total_capital"]); ?></label></td>
                                            </tr>
                                            <tr>
                                                <td class="center"><label style="height: 15px;">总盈亏</label></td>
                                                <td><label><?php echo ($vo["total_profit_loss"]); ?></label></td>
                                            </tr>
                                            <tr>
                                                <td class="center"><label style="height: 15px;">可用保证金</label></td>
                                                <td><label><?php echo ($vo["usable_margin"]); ?></label></td>
                                            </tr>
                                            <tr>
                                                <td class="center"><label style="height: 15px;">占用保证金</label></td>
                                                <td><label><?php echo ($vo["uccupy_margin"]); ?></label></td>
                                            </tr>
                                            <tr>
                                                <td class="center"><label style="height: 15px;">冻结保证金</label></td>
                                                <td><label><?php echo ($vo["freeze_margin"]); ?></label></td>
                                            </tr>
                                            <!--<tr>
                                                <td class="center"><label style="height: 15px;">手机</label></td>
                                                <td><input name="mobilephone" type="text" placeholder="手机" class="col-xs-10 col-sm-3" value="<?php echo ($vo["mobilephone"]); ?>"></td>
                                            </tr>
                                            <tr>
                                                <td class="center"><label style="height: 15px;">邮箱</label></td>
                                                <td><input name="email" type="text" placeholder="邮箱" class="col-xs-10 col-sm-3" value="<?php echo ($vo["email"]); ?>"></td>
                                            </tr>
                                            <tr>
                                                <td class="center"><label style="height: 15px;">等级</label></td>
                                                <td><input name="level" type="text" placeholder="等级" class="col-xs-10 col-sm-3" value="<?php echo ($vo["level"]); ?>"></td>
                                            </tr>
                                            <tr>
                                                <td class="center"><label>模拟ID</label></td>
                                                <td><label><?php echo ($vo["simulate_id"]); ?></label></td>
                                            </tr>
                                            <tr>
                                                <td class="center"><label style="height: 15px;">内容</label></td>
                                                <td id="ckf" onclick="ckf()">
                                                    <textarea placeholder="点击加载编辑器"  id="editor1" name="text"><?php echo ($vo["text"]); ?></textarea>
                                                </td>
                                            </tr>
                                            <tr class="center">
                                                <td><label style="height: 15px;">封面图片</label></td>
                                                <td><input type="file" name="photo" /></td>
                                            </tr>
                                            <tr class="center">
                                                <td style="line-height: 74px;">图片预览：</td>
                                                <td style="text-align: left;"><img width="114px" height="74px;" src="/Up<?php echo ($vo["image"]); ?>" /></td>
                                            </tr>
                                            <input type="hidden" value="<?php echo ($vo["uid"]); ?>" name="id" />-->

                                    <tr>
                                        <td class="center"></td>
                                        <td>
                                            <a href="<?php echo U('Capital/addMoney',array('id'=>$vo['uid']));?>"><button style="float:right;margin-right:5%;" class="btn btn-sm btn-primary no-border">入金10万</button></a>
                                            <a href="<?php echo U('Capital/subtractMoney',array('id'=>$vo['uid']));?>"><button style="float: right;margin-right: 7%;" class="btn btn-sm btn-primary no-border">减金10万</button></a>
                                        </td>
                                    </tr>
                                    </tbody>
