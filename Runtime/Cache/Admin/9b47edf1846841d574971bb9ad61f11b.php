                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="table-responsive">
                            <form action="/Admin/Allowip/save"  enctype="multipart/form-data" method="post">
                                <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody style="font-family:'Microsoft YaHei';">
                                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                                ...
                                                <td><input name="ip" type="text" placeholder="用户名" class="col-xs-10 col-sm-3" value="<?php echo ($vo["ip"]); ?>"></td>
                                            </tr>
